...
Update /public/js/gtag.js with your own Google Tag and ALLOWED_HOSTS URL if enabling Google Analytics.
...
Refresh periodically or after major catalog changes:
...
**Local testing:** ChatGPT desktop in-app browser, or Chrome 149+ with `chrome://flags/#enable-webmcp-testing`.
...
- Additional subcategory filtering within category pages

## License

Public project under MIT license.
